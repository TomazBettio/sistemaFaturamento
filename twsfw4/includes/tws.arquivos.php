	...
	public function __toString(){
		...
		if($this->verificaPermissaoUsuario($programaLink)){
			...
			if(is_array($obj->funcoes_publicas) && isset($obj->funcoes_publicas[$this->_metodo])){
				...
				log::logAcesso('Programa ARQUIVOS: '.$programaLink, 4);
				$ret = "Tentativa de acesso a funcao nao publica ou inexistente - ARQUIVOS<br>";
			}
			
		}else{
			log::logAcesso('Programa ARQUIVOS - Sem Permissao: '.$programaLink, 4);
