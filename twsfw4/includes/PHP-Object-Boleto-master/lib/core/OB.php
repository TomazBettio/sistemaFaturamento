...
class OB{
    ...
    public function geraCodigo(){
        ...
        if(empty($this->Boleto->CodigoBarras)){
            ...
            $cod = Strin::insert($this->Banco->layoutCodigoBarras, $this->Data);
            ...
            $this->Boleto->CodigoBarras = Strin::putAt($cod, $dv, 4);
        }
    ...
    public function linhaDigitavel(){
        ...
        $linhaDigitavel = Strin::putAt($linhaDigitavel, $dv3, 29);
        $linhaDigitavel = Strin::putAt($linhaDigitavel, $dv2, 19);
        $linhaDigitavel = Strin::putAt($linhaDigitavel, $dv1, 9);
       
        #Aplicando A linha digitável gerada à sua máscara
        $linhaDigitavel = Strin::applyMask($linhaDigitavel, $this->Banco->mascaraLinhaDigitavel);
   ...
   public static function zeros($text, $length, $cut = false){
    ...
    public static function normalize(&$var, $length){
        return Strin::left(self::zeros($var, $length), $length);
    }
}
