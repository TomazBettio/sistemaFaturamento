...
class Barcode{
    ...
    public function getBarcode($code){
        ...
        //Exibindo a image
        //echo $this->image;
        //file_put_contents('/var/www/crm_dev/html/codigosDeBarra/imagem.png', $this->image);
        imagepng($this->image, "/var/www/crm_dev/html/codigosDeBarra/$code.png"); 
...
function criaImagem($cod) {
    $cod = $_GET['n'] ?? $cod;
    if(isset($cod)) Barcode::getImage($cod);
}