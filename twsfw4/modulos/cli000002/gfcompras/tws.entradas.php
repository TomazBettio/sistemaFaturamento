...
class entradas{
	...
	function __construct(){
		...
		$this->_programa = 'entradas';
		
		$param = [];
		$param['programa']	= $this->_programa;
		$this->_relatorio = new relatorio01($param);
		$this->_relatorio->addColuna(array('campo' => 'tipo'		, 'etiqueta' => 'Tipo'			, 'tipo' => 'T', 'width' => 100, 'posicao' => 'E'));
		$this->_relatorio->addColuna(array('campo' => 'fornec'		, 'etiqueta' => 'Cod.'			, 'tipo' => 'T', 'width' =>  80, 'posicao' => 'E'));
		...
		$this->_relatorio->addColuna(array('campo' => 'emissao'		, 'etiqueta' => 'Emissao'		, 'tipo' => 'T', 'width' => 100, 'posicao' => 'E'));
		$this->_relatorio->addColuna(array('campo' => 'entrada'		, 'etiqueta' => 'Entrada'		, 'tipo' => 'T', 'width' => 100, 'posicao' => 'E'));
	...
	function index(){
		...
		$this->_relatorio->setTitulo("Entradas.");
		if(!$this->_relatorio->getPrimeira()){
			$this->_relatorio->setTitulo("Entradas. Periodo: ".datas::dataS2D($dataIni)." a ".datas::dataS2D($dataFim));
...
//$data = '20190110';
		$this->_relatorio->setTitulo("Entradas. Dia: ".datas::dataS2D($data));
...
//print_r($dados);		
		...
		$this->_relatorio->setToExcel(true, 'entradas_'.datas::dataS2D($data,2,'.'));
		...
		if(!$this->_teste){
			...
			log::gravaLog('entradas_dia', 'Enviado email: '.$emails);
		}else{
			$this->_relatorio->enviaEmail('suporte@thielws.com.br');
			log::gravaLog('entradas_dia', 'Enviado email: thiel@thielws.com.br');
		}
	}
